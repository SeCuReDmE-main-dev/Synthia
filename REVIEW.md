...
Project-specific focus: Swarm determinism, source attribution, human review, real vision transport instead of filename heuristics, and strict distinction between Synthia actions and external agent actions.
