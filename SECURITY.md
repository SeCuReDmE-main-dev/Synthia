...
Synthia is pre-alpha. There are no production-supported versions yet. Security fixes target the current main branch unless a maintainer explicitly publishes another supported line.

## Scope

Security-sensitive areas include traceable scientific memory, taxonomy records, source admission, provenance, and human review. Reports should focus on real behavior in this repository or on its documented gateway boundary.
