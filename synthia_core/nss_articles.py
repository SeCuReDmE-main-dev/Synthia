...
FAMILY_KEYWORDS: dict[str, tuple[tuple[str, float], ...]] = {
    ...
    "plithogenic": (
        ...
        ("dominant value", 1.5),
        ("refined", 1.2),
        ("plithogenic probability", 1.8),
        ("plithogenic statistics", 1.8),
    ...
    "symbolic_algebra": (
        ("symbolic", 1.7),
        ("symbolic plithogenic", 2.0),
        ("plithogenic number", 1.8),
        ("absorbance", 1.5),
        ("algebra", 1.2),
        ("algebraic", 1.2),
        ("number", 0.7),
    ...
    "hypersoft": (
        ("hypersoft", 2.0),
        ("plithogenic hypersoft", 2.2),
        ("soft set", 1.5),
        ("attribute product", 1.3),
        ("parameter", 0.9),
        ("multi-criteria", 1.1),
        ("rough fuzzy", 0.8),
    ),
