...
NSS_SOURCE_FAMILIES: tuple[NSSSourceFamily, ...] = (
    ...
    NSSSourceFamily(
        ...
        ("PlithogenicMatrix", "PlithogenicSetProfile", "PlithogenicLogicalProposition", "I_lexicon", "NSSMathRouter"),
        "System-level multi-attribute contradiction, set, and logic indeterminacy layer.",
        ("plithogenic", "contradiction", "attribute", "dominant value", "multivariate", "cumulative truth"),
    ),
    NSSSourceFamily(
        "symbolic_algebra",
