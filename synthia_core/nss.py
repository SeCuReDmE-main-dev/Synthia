...
NSS_SOURCE_FAMILIES: tuple[NSSSourceFamily, ...] = (
    ...
    NSSSourceFamily(
        ...
        ("I_lexicon", "HippoRAGMemoryBit", "TaxonomicReviewPacket"),
        "Probability and statistics support for document filtration and lexicon uncertainty.",
        ("probability", "statistics", "distribution", "random variable", "entropy"),
    ),
    NSSSourceFamily(
        "plithogenic",
        ...
        ("PlithogenicMatrix", "I_lexicon", "NSSMathRouter"),
        "System-level multi-attribute contradiction and indeterminacy layer.",
        ("plithogenic", "contradiction", "attribute", "dominant value", "multivariate"),
    ),
    NSSSourceFamily(
        "symbolic_algebra",
        ...
        ("SymbolicNotation", "PlithogenicIProfile"),
        "Notation and symbolic structure for future math-language rendering.",
        ("symbolic", "algebra", "notation", "structure"),
    ),
    NSSSourceFamily(
        "hypersoft",
        ...
        ("I_lexicon", "LexiconNode", "TaxonomicReviewPacket"),
        "Attribute-parameter structures for multi-criteria taxonomy filtering.",
        ("hypersoft", "soft set", "parameter", "multi-criteria"),
    ),
    NSSSourceFamily(
        "neutroalgebra",
        ...
        ("HippoRAGMemoryBit", "LexiconBridge"),
        "Future math lexicon for partially defined or indeterminate graph operations.",
        ("neutroalgebra", "partial algebra", "operation", "axiom"),
    ),
    NSSSourceFamily(
        "neutrogeometry",
